              ...
              <?php 
                if ($result->num_rows > 0) {
                  ...
                  while($row = $result->fetch_assoc()) {
                      echo '<tr>'.'<td>' . $cnt. " </td>".'<td>' . $row["name"]. " </td>".'<td>' . $row["city"]. " </td>".'<td><form action="assign_algo.php" method="post"><input type="text" name="orderID" placeholder="Enter Order ID" required></td><td><input type="text" name="mail" placeholder="Enter email" required></td>'.'<td><button class="button" name="submit">assign</button></form>'. " </td>".'</tr>';
                      $cnt++;
                  }
                }
              ?>
