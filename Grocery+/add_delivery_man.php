...
<body>
  ...
  if (isset($_POST['signup_btn'])) {
    ...
    if (count($errors) == 0) {
      $insquery = "INSERT INTO delivery_man (email_id, password, phone_number, name, location, city, state, pincode)
    			  VALUES('$email', '$password', '$phone_no', '$name', '$loc', '$city', '$state', '$pin')";
    	if($db->query($insquery) == TRUE)
      {
      	echo "<script>alert('Deliver Man Added Successfully!')</script>";
      }
      else {
    ...
    <div class="center">
      <div class="login-box">
        <div class="heading-box">
          <h3 align="center"><b>Delivery Man Details</b> </h3>
        </div>
        <div class="container">
