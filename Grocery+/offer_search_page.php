...
<head>
  ...
  <link rel="stylesheet" href="styles/offer_search_page/offer_search_page_style.css">
        ...
        <div class="row justify-content-center rowHeight">
          <div class="col align-self-center">
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title title_css"><?php echo $row['offer_name'] ?></h5>
                <p class="card-text">Get a discount of <?php echo $row['percentage']."%" ?> on these products</p>
                <?php $link = "product_search_page.php?offer_id=".$row['offer_id'] ?>
                <a href=<?php echo $link ?> class="btn btn-primary">BROWSE PRODUCTS</a>
              </div>
            </div>
          </div>
        </div>
